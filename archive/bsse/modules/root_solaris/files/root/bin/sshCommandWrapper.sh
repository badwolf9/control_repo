...
case `echo $SSH_ORIGINAL_COMMAND | awk '{print $1 " " $2 " " $3}'` in
    ...
    ;;
    "rsync --server -logDtpre.iLsfx") $SSH_ORIGINAL_COMMAND
    ;;
    "rsync --server -vlogDtpre.iLs") $SSH_ORIGINAL_COMMAND
    ;;
    "rsync --server -logDtpre.is") $SSH_ORIGINAL_COMMAND
    ;;
    "rsync --server -logDtpre.iLsfxC") $SSH_ORIGINAL_COMMAND
    ;;
    ...
    "scp -t /tmp") $SSH_ORIGINAL_COMMAND
    ;;
    "scp -f /etc/description") $SSH_ORIGINAL_COMMAND
    ;;
    ...
    ;; 
    "zfs send -i") $SSH_ORIGINAL_COMMAND
    ;;
    ...
    ;;
    "/mnt/itsc/solaris/bin/mbuffer -q -s") eval $SSH_ORIGINAL_COMMAND
    ;;
    ": : :") :
    ;;
