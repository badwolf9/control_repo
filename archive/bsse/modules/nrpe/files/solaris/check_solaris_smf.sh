...
#
# $Id: check_solaris_smf.sh,v 1.2 2008/09/17 08:06:15 kivimaki Exp $
#
# Copyright (C) 2008  Hannu Kivimäki / CSC - Scientific Computing Ltd.
#
...
printInfo() {
    ...
    echo "Copyright (C) 2008  Hannu Kivimäki / CSC - Scientific Computing Ltd."
}
...
printVersion() {
    echo
    echo "\$Id: check_solaris_smf.sh,v 1.2 2008/09/17 08:06:15 kivimaki Exp $"
    echo
}
