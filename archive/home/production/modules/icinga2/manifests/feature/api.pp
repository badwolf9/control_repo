...
class icinga2::feature::api(
  ...
  Optional[Boolean]                                       $accept_config                    = true,
  Optional[Boolean]                                       $accept_commands                  = true,
  Optional[Integer[0]]                                    $max_anonymous_clients            = undef,
  Optional[Stdlib::Host]                                  $ca_host                          = undef,
  Stdlib::Port::Unprivileged                              $ca_port                          = 5665,
  String                                                  $ticket_salt                      = '963ee2dbe3906ec88978702a1575ced7',
  Optional[String]                                        $ticket_id                        = undef,
  Hash[String, Hash]                                      $endpoints                        = { 'NodeName'       => {}, 'mf-mm01'        => { 'host' => '192.168.100.12', } },
  Hash[String, Hash]                                      $zones                            = { 'ZoneName' => { endpoints => [ 'NodeName' ], 'parent' => 'master', } 'master' => { 'endpoints' => ['mf-mm01'], }, }
  ...
  Optional[Icinga2::Fingerprint]                          $fingerprint                      = '47:A5:CD:52:BA:10:E4:BD:9D:70:FF:17:22:74:38:32:93:6B:82:E3',
...
notify { "Running icinga2 feature/api.pp" : }
